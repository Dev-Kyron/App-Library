...
export default function ScreenshotGallery({ shots, title }: { shots: string[]; title: string }) {
  ...
  return (
    <div className="mb-6">
      {/* Main image */}
      <div className="relative w-full overflow-hidden rounded-xl border border-[#1e1a3a] bg-[#0a0a20]" style={{ aspectRatio: '16/9' }}>
        <Image
          key={active}
          src={shots[active]}
        ...
        <button
          onClick={prev}
          className="absolute left-3 top-1/2 -translate-y-1/2 flex h-10 w-10 items-center justify-center rounded-full border border-[#2a1a4e] bg-[#0a0a12]/80 text-[#a855f7] backdrop-blur-sm transition-all hover:bg-[#7c3aed]/30 hover:border-[#7c3aed]"
          aria-label="Previous"
        >
        ...
        <button
          onClick={next}
          className="absolute right-3 top-1/2 -translate-y-1/2 flex h-10 w-10 items-center justify-center rounded-full border border-[#2a1a4e] bg-[#0a0a12]/80 text-[#a855f7] backdrop-blur-sm transition-all hover:bg-[#7c3aed]/30 hover:border-[#7c3aed]"
          aria-label="Next"
        >
          <svg width="18" height="18" viewBox="0 0 16 16" fill="none">
